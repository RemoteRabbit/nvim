---@module "utils.pr_description.links"
---@brief [[
...
---@return integer count Number of replacements made
function M.add_jira_links(text)
...
function M.add_all_links(text, repo_url, is_gitlab)
  text = M.add_issue_links(text, repo_url, is_gitlab)
  text = M.add_jira_links(text)
  return text
end
