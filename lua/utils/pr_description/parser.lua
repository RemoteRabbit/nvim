---@module "utils.pr_description.parser"
---@brief [[
...
local COMMIT_PATTERNS = {
  ...
  { category = "chores", patterns = { "^chore[!%(:]", "^ci[!%(:]", "^build[!%(:]" } },
...
---@field features string[] Feature commits
---@field fixes string[] Bug fix commits
---@field docs string[] Documentation commits
---@field refactor string[] Refactoring commits
---@field tests string[] Test commits
---@field style string[] Style/formatting commits
---@field chores string[] Maintenance/CI commits
---@field reverts string[] Revert commits
---@field wip string[] Work-in-progress commits
---@field breaking string[] Breaking change commits
---@field others string[] Uncategorized commits
